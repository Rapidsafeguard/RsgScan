...
class Controller():
    ...
    def __init__(self, view, logic):
        self.name = "Rapidsafeguard"
        self.version = '0.1'
        self.copyright = '2019'
        self.links = ['', 'www.rapidsafeguard.com']
        self.build = '5500'
        self.author ="Rapidsafeguard Punit Darji"
        self.emails = ['secure@rapidsafeguard.com']

        self.update = '28/05/2019'

        self.license = "Company"
        self.desc = "RSG Scanner is a fork of network scanning tool, RSG Scanner is an open source, easy to-use, \nsuper-extensible and semi-automated network penetration testing tool that aids in discovery, \nreconnaissance and exploitation of information systems."
        self.smallIcon = './images/icons/RSG.svg'
        self.bigIcon = './images/icons/RSG.svg'
        self.logic = logic
        self.view = view
